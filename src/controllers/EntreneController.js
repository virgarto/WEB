...
/*
            ...
            conn.query('INSERT INTO entrenamiento_danza (id_travelling, id_cluster, id_pattern_sq, id_ar_foot_sq, id_dance_step_sq, id_footwork_sq, id_choreo_step, id_bracket_der, id_bracket_izq, id_counter_der, id_counter_izq, id_rocker_der, id_rocker_izq, id_loop_der, id_loop_izq SELECT id_travelling, id_cluster, id_pattern_sq, id_ar_foot_sq, id_dance_step_sq, id_footwork_sq, id_choreo_step, id_bracket_der, id_bracket_izq, id_counter_der, id_counter_izq, id_rocker_der, id_rocker_izq, id_loop_der, id_loop_izq FROM entrenamiento_danza_temp');
            conn.query('DELETE FROM entrenamiento_danza_temp');
            conn.query('INSERT INTO entrenamiento_danza (id_patinador) VALUE (?) WHERE id = (SELECT MAX(id) FROM entrenamiento_danza)', [id[0].pat_ID]);
      */  })
